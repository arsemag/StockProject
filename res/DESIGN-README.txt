...
In the command package and readerbuilder package we did not need to change any old code, except
for InputAPIStockCommand where we added an if statement that prevents a call to the API
if the portfolio already has that stock.
